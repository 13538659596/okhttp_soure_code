...
class AndroidPlatform extends okhttp3.internal.platform.Platform {
  ...
  private final okhttp3.internal.platform.OptionalMethod<Socket> setUseSessionTickets;
  private final okhttp3.internal.platform.OptionalMethod<Socket> setHostname;

  // Non-null on Android 5.0+.
  private final okhttp3.internal.platform.OptionalMethod<Socket> getAlpnSelectedProtocol;
  private final okhttp3.internal.platform.OptionalMethod<Socket> setAlpnProtocols;

  private final CloseGuard closeGuard = CloseGuard.get();

  AndroidPlatform(Class<?> sslParametersClass, okhttp3.internal.platform.OptionalMethod<Socket> setUseSessionTickets,
                  okhttp3.internal.platform.OptionalMethod<Socket> setHostname, okhttp3.internal.platform.OptionalMethod<Socket> getAlpnSelectedProtocol,
                  okhttp3.internal.platform.OptionalMethod<Socket> setAlpnProtocols) {
  ...
  public static Platform buildIfSupported() {
    ...
    try {
      ...
      okhttp3.internal.platform.OptionalMethod<Socket> setUseSessionTickets = new okhttp3.internal.platform.OptionalMethod<>(
          null, "setUseSessionTickets", boolean.class);
      okhttp3.internal.platform.OptionalMethod<Socket> setHostname = new okhttp3.internal.platform.OptionalMethod<>(
          null, "setHostname", String.class);
      okhttp3.internal.platform.OptionalMethod<Socket> getAlpnSelectedProtocol = null;
      okhttp3.internal.platform.OptionalMethod<Socket> setAlpnProtocols = null;

      if (supportsAlpn()) {
        getAlpnSelectedProtocol
            = new okhttp3.internal.platform.OptionalMethod<>(byte[].class, "getAlpnSelectedProtocol");
        setAlpnProtocols
            = new okhttp3.internal.platform.OptionalMethod<>(null, "setAlpnProtocols", byte[].class);
      }
