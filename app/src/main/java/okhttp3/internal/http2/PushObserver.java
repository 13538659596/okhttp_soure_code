...
public interface PushObserver {
   ...
   * and {@code :path}.
   */
  boolean onRequest(int streamId, List<okhttp3.internal.http2.Header> requestHeaders);
   ...
   */
  boolean onHeaders(int streamId, List<okhttp3.internal.http2.Header> responseHeaders, boolean last);
  ...
  PushObserver CANCEL = new PushObserver() {
    ...
    @Override public boolean onRequest(int streamId, List<okhttp3.internal.http2.Header> requestHeaders) {
      return true;
    }
