...
public final class StreamAllocation {
  ...
  public HttpCodec newStream(
    ...
    try {
      okhttp3.internal.connection.RealConnection resultConnection = findHealthyConnection(connectTimeout, readTimeout,
   ...
   */
  private okhttp3.internal.connection.RealConnection findHealthyConnection(int connectTimeout, int readTimeout,
                                                                           int writeTimeout, boolean connectionRetryEnabled, boolean doExtensiveHealthChecks)
      throws IOException {
    while (true) {
      okhttp3.internal.connection.RealConnection candidate = findConnection(connectTimeout, readTimeout, writeTimeout,
  ...
  private Socket releaseIfNoNewStreams() {
    ...
    okhttp3.internal.connection.RealConnection allocatedConnection = this.connection;
   ...
   */
  public void acquire(okhttp3.internal.connection.RealConnection connection, boolean reportedAcquired) {
    assert (Thread.holdsLock(connectionPool));
  ...
  private void release(okhttp3.internal.connection.RealConnection connection) {
   ...
   * of the synchronized block. (We don't do I/O while synchronized on the connection pool.)
   */
  public Socket releaseAndAcquire(okhttp3.internal.connection.RealConnection newConnection) {
    assert (Thread.holdsLock(connectionPool));
