...
public final class ConnectionSpec {
  ...
  private static final okhttp3.CipherSuite[] APPROVED_CIPHER_SUITES = new okhttp3.CipherSuite[] {
  ...
  public static final ConnectionSpec MODERN_TLS = new Builder(true)
      ...
      .tlsVersions(okhttp3.TlsVersion.TLS_1_3, okhttp3.TlsVersion.TLS_1_2, okhttp3.TlsVersion.TLS_1_1, okhttp3.TlsVersion.TLS_1_0)
      .supportsTlsExtensions(true)
      .build();

  /** A backwards-compatible fallback connection for interop with obsolete servers. */
  public static final ConnectionSpec COMPATIBLE_TLS = new Builder(MODERN_TLS)
      .tlsVersions(okhttp3.TlsVersion.TLS_1_0)
      .supportsTlsExtensions(true)
      .build();
   ...
   */
  public @Nullable List<okhttp3.CipherSuite> cipherSuites() {
    return cipherSuites != null ? okhttp3.CipherSuite.forJavaNames(cipherSuites) : null;
  }
   ...
   */
  public @Nullable List<okhttp3.TlsVersion> tlsVersions() {
    return tlsVersions != null ? okhttp3.TlsVersion.forJavaNames(tlsVersions) : null;
  }
  ...
  private ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
    String[] cipherSuitesIntersection = cipherSuites != null
        ? intersect(okhttp3.CipherSuite.ORDER_BY_NAME, sslSocket.getEnabledCipherSuites(), cipherSuites)
    ...
    int indexOfFallbackScsv = indexOf(
        okhttp3.CipherSuite.ORDER_BY_NAME, supportedCipherSuites, "TLS_FALLBACK_SCSV");
  ...
  public boolean isCompatible(SSLSocket socket) {
    ...
    if (cipherSuites != null && !nonEmptyIntersection(
        okhttp3.CipherSuite.ORDER_BY_NAME, cipherSuites, socket.getEnabledCipherSuites())) {
      return false;
    }
