 ...
 * remain idle.
 */
public class OkHttpClient implements Cloneable, okhttp3.Call.Factory, okhttp3.WebSocket.Factory {
  static final List<okhttp3.Protocol> DEFAULT_PROTOCOLS = Util.immutableList(
      okhttp3.Protocol.HTTP_2, okhttp3.Protocol.HTTP_1_1);
  ...
  static {
    Internal.instance = new Internal() {
      @Override public void addLenient(okhttp3.Headers.Builder builder, String line) {
      ...
      @Override public RealConnection get(ConnectionPool pool, okhttp3.Address address,
          StreamAllocation streamAllocation, Route route) {
        return pool.get(address, streamAllocation, route);
      }

      @Override public boolean equalsNonHost(okhttp3.Address a, okhttp3.Address b) {
      ...
      @Override public int code(okhttp3.Response.Builder responseBuilder) {
      ...
      @Override public okhttp3.HttpUrl getHttpUrlChecked(String url)
  ...
  final List<okhttp3.Protocol> protocols;
  ...
  public List<okhttp3.Protocol> protocols() {
    return protocols;
  }
  ...
  public static final class Builder {
    ...
    List<okhttp3.Protocol> protocols;
     ...
     *
     * <p>If unset, {@linkplain okhttp3.CookieJar#NO_COOKIES no cookies} will be accepted nor provided.
     */
     ...
     *
     * <p>If unset, the {@link okhttp3.Dns#SYSTEM system-wide default} DNS will be used.
     */
     ...
     *
     * <p>{@link okhttp3.Protocol#HTTP_1_0} is not supported in this set. Requests are initiated with {@code
     * HTTP/1.1} only. If the server responds with {@code HTTP/1.0}, that will be exposed by {@link
     * Response#protocol()}.
     *
     * @param protocols the protocols to use, in order of preference. The list must contain {@link
     * okhttp3.Protocol#HTTP_1_1}. It must not contain null or {@link okhttp3.Protocol#HTTP_1_0}.
     */
    public Builder protocols(List<okhttp3.Protocol> protocols) {
      // Create a private copy of the list.
      protocols = new ArrayList<>(protocols);

      // Validate that the list has everything we require and nothing we forbid.
      if (!protocols.contains(okhttp3.Protocol.HTTP_1_1)) {
        throw new IllegalArgumentException("protocols doesn't contain http/1.1: " + protocols);
      }
      if (protocols.contains(okhttp3.Protocol.HTTP_1_0)) {
