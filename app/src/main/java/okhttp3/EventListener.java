...
public abstract class EventListener {
   ...
   *
   * <p>This will be invoked only once for a single {@link okhttp3.Call}. Retries of different routes
   ...
   *
   * <p>This can be invoked more than 1 time for a single {@link okhttp3.Call}. For example, if the response
   * to the {@link okhttp3.Call#request()} is a redirect to a different host.
   *
   * <p>If the {@link okhttp3.Call} is able to reuse an existing pooled connection, this method will not be
   ...
   */
  public void dnsEnd(okhttp3.Call call, String domainName, @Nullable List<InetAddress> inetAddressList) {
  }
   ...
   *
   * <p>This can be invoked more than 1 time for a single {@link okhttp3.Call}. For example, if the response
   * to the {@link okhttp3.Call#request()} is a redirect to a different address, or a connection is retried.
   */
   ...
   * <ul>
   * <li>The {@link okhttp3.Call#request()} requires TLS.</li>
   ...
   */
  public void secureConnectEnd(okhttp3.Call call, @Nullable okhttp3.Handshake handshake) {
  }
   ...
   * {@link #secureConnectEnd(okhttp3.Call, okhttp3.Handshake)}, otherwise it will invoked after
   * {@link #connectStart(okhttp3.Call, InetSocketAddress, Proxy)}.
   */
  public void connectEnd(okhttp3.Call call, InetSocketAddress inetSocketAddress,
                         @Nullable Proxy proxy, @Nullable okhttp3.Protocol protocol) {
  }
   ...
   *
   * <p>If the {@code call} uses HTTPS, this will be invoked after {@link #secureConnectEnd(okhttp3.Call,
   * Handshake)}, otherwise it will invoked after {@link #connectStart(okhttp3.Call, InetSocketAddress,
   * Proxy)}.
   */
  public void connectFailed(okhttp3.Call call, InetSocketAddress inetSocketAddress,
   ...
   *
   * <p>This can be invoked more than 1 time for a single {@link okhttp3.Call}. For example, if the response
   * to the {@link okhttp3.Call#request()} is a redirect to a different address.
   */
   ...
   *
   * <p>This method is always invoked after {@link #connectionAcquired(okhttp3.Call, okhttp3.Connection)}.
   *
   * <p>This can be invoked more than 1 time for a single {@link okhttp3.Call}. For example, if the response
   * to the {@link okhttp3.Call#request()} is a redirect to a different address.
   */
   ...
   * {@link #connectionAcquired(okhttp3.Call, okhttp3.Connection)} event.
   *
   * <p>This can be invoked more than 1 time for a single {@link okhttp3.Call}. For example, if the response
   * to the {@link okhttp3.Call#request()} is a redirect to a different address.
   */
   ...
   *
   * <p>This method is always invoked after {@link #requestHeadersStart(okhttp3.Call)}.
   *
   ...
   *
   * <p>This method is always invoked after {@link #requestBodyStart(okhttp3.Call)}.
   */
   ...
   *     this response.
   */
  public void responseHeadersEnd(okhttp3.Call call, Response response) {
  }
   ...
   *
   * <p>The connection is implicit, and will generally relate to the last
   * {@link #connectionAcquired(okhttp3.Call, Connection)} event.
   *
   * <p>This will usually be invoked only 1 time for a single {@link okhttp3.Call},
   ...
   *
   * <p>This method is always invoked after {@link #callStart(okhttp3.Call)}.
   */
  ...
  public interface Factory {
    /**
     * Creates an instance of the {@link EventListener} for a particular {@link okhttp3.Call}. The returned
